...
import classroomImage from "../../assets/GROUP-6.jpg";
import studentCommunityImage from "../../assets/classrooms.jpg";
  ...
  return (
    <div className="scroll-root">
      <main className="ptc-about-page">
        <section className="ptc-about-hero">
          <div className="ptc-about-hero__copy">
            ...
            <p className="ptc-about-hero__lead">
              ...
              prepare for their future careers and become productive members
              of society.
            </p>

            <div
              className="ptc-about-hero__principles"
              aria-label="PTC focus areas"
            >
              <span>
          ...
          <div
            className="ptc-about-hero__visual"
            aria-label="Pateros Technological College campus"
          >
            <img
              src={campusImage}
        ...
        <section
          className="ptc-about-intro"
          aria-labelledby="ptc-about-guides-title"
        >
          <div className="ptc-about-section-heading">
            <span className="ptc-about-section-kicker">
              What guides us
            </span>
        ...
        <section
          className="ptc-about-experience"
          aria-labelledby="ptc-about-experience-title"
        >
          ...
          <div className="ptc-about-experience__copy">
            ...
            <p>
              ...
              explore their interests, and prepare for opportunities beyond
              the classroom.
            </p>
            ...
            <div className="ptc-about-experience__points">
              <div>
                ...
                <div>
                  ...
                  <p>
                    Knowledge and skills are centered on helping students
