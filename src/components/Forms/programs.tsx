...
import classroomImage from "../../assets/paths.png";
...
const focusAreas = [
  {
    ...
    description:
      "Build knowledge and skills through career-focused academic programs.",
    icon: Lightbulb,
  },
  {
    title: "Technology Ready",
    description:
      "Develop capabilities that support learning in modern academic and work environments.",
    icon: MonitorCog,
  },
  {
    title: "Student Development",
    description:
      "Grow through an academic environment centered on learning and preparation.",
    icon: UsersRound,
  },
];
      ...
      <main className="ptc-programs-page">
        <section className="ptc-programs-hero">
          <div className="ptc-programs-hero__copy">
            ...
            <div
              className="ptc-programs-hero__meta"
              aria-label="Program page highlights"
            >
              <span>
        ...
        >
          <div className="ptc-programs-section-heading">
            <span className="ptc-programs-section-kicker">
              Programs offered
            </span>

            <h2 id="ptc-programs-catalog-title">
              Academic pathways at PTC
            </h2>
