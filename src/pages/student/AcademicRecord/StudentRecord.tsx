...
export default function StudentRecord() {
  ...
  const students: Record<
    string,
    { name: string; img: string; text: string; link: string }
  > = {
    A: {
      name: "Curriculum",
  ...
  return (
    <DashboardLayout>
      <div className="studentrecords">
        <p
          style={{ fontSize: "24px", fontWeight: "bold", marginBottom: "50px" }}
        >
          This is your student records.
        </p>
        ...
        <div className="gallery2" style={{ display: "flex", gap: "99px" }}>
          {Object.keys(students).map((key) => (
            ...
            >
              <img src={students[key].img} alt={students[key].name} />
              <p
                style={{
                  position: "absolute",
                  bottom: "0",
